          ...
          <div class="col-md-5 text-center text-md-left pt-5 pt-md-0">
            ...
            <div class="intro-text text-center text-md-left">
              <p class="mb-4"><?= Yii::t('app', 'lorem') ?><p>
                <a href="<?= \yii\helpers\Url::to('@web') ?>/shop" class="btn btn-sm btn-primary"><?= Yii::t('app', 'shop_now') ?></a>
              </p>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        ...
        <div class="row align-items-center">
          ...
          <div class="col-md-12 col-lg-5 text-center pl-md-5">
            ...
            <p><a href="<?= \yii\helpers\Url::to('@web') ?>/shop" class="btn btn-primary btn-sm"><?= Yii::t('app', 'shop_now') ?></a></p>
          </div>
        </div>
      </div>
    </div>
