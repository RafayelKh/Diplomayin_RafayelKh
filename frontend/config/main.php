    ...
    'components' => [
        ...
        'urlManager' => [
            ...
            'rules' => [
                ...
                'shop/<action:(newBeginning|newEnd|lowHigh|highLow)>' => 'product/products',
                'shop/cat/<cat_id>' => 'product/products',
                'shop/prod/<slug>' => 'product/products/product',
                'shop/brand/<br_id>' => 'product/products',
                'shop/show/<qty>' => 'product/products',
                'blog/' => 'blog/blog',
                "blog/<id>" => 'blog/blog/article',
//                "blog/add/<add_id>/<id>" => 'blog/blog/article',
